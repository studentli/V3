	...
	<body style="background: #fff;">
		...
		<div id="topPopover" class="top_list" >
 	    ...
 	    <div class="content_con" style="padding:0px;padding-top: 44px;">
			 <div class="count_num">
			 	<p>可用激活币：</p>
			 	<p style="font-size: 20px;"><?php echo ($userData['pinCount']); ?></p>
			 </div>
			 <div class="give_con">
			 	<form name="form1" class="form01" method="post" action="/Home/Index/jbzzcl/">
					<label>
                        <span>激活币转让,数量:</span>
					...
					<label>
                    	<a href="<?php echo U("Home/Info/pin_list");?>" type="button" class="give_list">转让记录</a>
                    </label>
</form>
			 </div>
