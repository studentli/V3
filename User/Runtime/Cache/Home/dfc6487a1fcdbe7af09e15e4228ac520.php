...
<!-- Main Wrapper -->
            ...
            <!-- <div class="modal-header">
                ...
                <input type="radio" class="comfir2" value="1" name="comfir2">我完成打款<br><br><br>
              <!--  <p>二级密码</p>
               
               <input type="password" class="form-control "  name="password" > -->

                <input type="hidden" value="" id="comid2">
                <input type="hidden" value="" name='face180' id="face180">
            ...
            <div style="font-size:9pt;">
                ...
                　　<input style="float:left;" type="submit" id="btn_approve_donation" class="btn btn-primary btn-sm" value="确认已付款"><br>
<br>
