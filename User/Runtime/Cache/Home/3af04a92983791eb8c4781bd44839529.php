...
<script type="text/javascript" src='/Public/Uploadify/jquery.uploadify.min.js'></script>
 <script type='text/javascript'>
        ...
        var PUBLIC = '/Public';
        var uploadUrl = '<?php echo U("Upload/uploadFace");?>';
        var ROOT = '';
    </script>
...
<!-- Main Wrapper -->
 ...
 <form class="" method="post" id="pfrom" enctype="multipart/form-data" action="/Home/Index/home_ddxx_gcz_cl/">
			<div class="modal-body" style="height:300px;">
               <!--  如果未收款到并且汇款截图是假的,请先对方取得联系,联系后还不能解决问题,在选择未收到款投诉,并且上传您的截图! -->
                如果未收款到并且汇款截图是假的,请联系客服!
                <br>

               
                <input type="hidden" id='face180' name='face180'>
                <input type="radio" class="comfir" value="1" name="comfir">确认收款<br>
				 				<input type="radio" class="comfir" value="1" name="comfir">投诉
				<p>二级密码</p>               
            ...
            <div style="font-size:9pt;">
                <!-- <a class="btn btn-primary btn-sm" id="img_btn">上传图片</a> -->　　　　<input type="submit" id="btn_approve_donation" class="btn btn-primary btn-sm" value="提交">
                <br>
<br>				<img src='' id='face-img'>
