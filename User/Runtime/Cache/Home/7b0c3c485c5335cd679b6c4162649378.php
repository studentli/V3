...
<div id="topPopover" class="top_list" >
 	     ...
 	     <div class="news_con">
 	     	<h3><?php echo ($data['if_theme']); ?></h3>
 	     	<p><?php echo ($data['if_content']); ?></p>
 	     </div>
 	     <style>
 	     	.news_con{padding:15px;padding-top: 50px;height:auto;overflow: hidden;}
 	     	.news_con h3{width:100%;text-align: center;height: auto;overflow: hidden;font-size: 16px;line-height: 36px;}
 	     	.news_con p{text-indent: 10px;color:#666;font-size: 14px;line-height: 24px;text-align: justify;}
 	     </style>
