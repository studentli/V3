...
<body>
  ...
  <tr>
    <td> <form id="form1" name="form1" method="post" action="/admdgjmin.php/Home/Index/ppdd_list">
	 
   <input name="user" type="text" class="dfinput" id="user" />
	<input name="" type="submit" class="btn" value="确认搜索"/>
      </form></td>
    <td align="right"><a href="/admdgjmin.php/Home/Index/ppdd_list/cz/0/">交易中</a> <a href="/admdgjmin.php/Home/Index/ppdd_list/cz/1/">交易成功</a></td>
  </tr>
  <tr>
    ...
    <table class="tablelist">
        ...
        <td><?php if($v["ts_zt"] == 1): ?>超时未打款<?php endif; ?>
			<?php if($v["ts_zt"] == 3): ?>超时未确认<?php endif; ?>
			<?php if($v["ts_zt"] == 2): ?>未收到款<?php endif; ?></td>
        <td><?php echo ($v["date"]); ?></td>
        <td><a href="/admdgjmin.php/Home/Index/ts1_list_cl/id/<?php echo ($v["id"]); ?>/">重新匹配</a></td>
