...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
      <form id="form1" name="form1" method="post" action="/admdgjmin.php/Home/Index/jbzscl">
    ...
    <ul class="forminfo"><li><label>赠送类型</label><cite><input name="lx" type="radio" value="jb" checked="checked" />
      静态积分&nbsp;&nbsp;&nbsp;&nbsp;<!--<input name="lx" type="radio" value="yb" />
    ...
    <li><label>&nbsp;</label><input name="" type="submit" class="btn" value="确认保存"/></li>
	 ...
	 <table class="tablelist">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 ...
		 <td><?php echo ($v["ug_account"]); ?></td>
		   <td><?php echo ($v["ug_gettime"]); ?></td>
		    <td>
			 <?php if($v["ug_type"] == 'jb'): ?>静态积分<?php echo ($v["ug_money"]); endif; ?>
        ...
        <td>
		 <?php if($v["ug_type"] == 'jb'): ?>静态积分<?php echo ($v["ug_balance"]); endif; ?>
