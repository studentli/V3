...
<body>
  ...
  <tr>
   ...
   <input name="user" type="text" class="dfinput" id="user" />
    ...
    <td align="right"><a href="/admdgjmin.php/Home/Index/tgbz_list/cz/0/">未匹配</a>
	<a href="/admdgjmin.php/Home/Index/tgbz_list/cz/1/">已匹配</a> 
  ...
  <tr>
    ...
    <table class="tablelist">
		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 <td><?php echo ($v["id"]); ?> <a onClick="javascript:if(!confirm('确认要删除吗？'))  return  false; " href="/admdgjmin.php/Home/Index/jsbz_list_del/id/<?php echo ($v["id"]); ?>" >删除</a></td>
        ...
        <td><a href="/admdgjmin.php/Home/Index/jsbz_list_sd/id/<?php echo ($v["id"]); ?>/">手动匹配</a></td>
