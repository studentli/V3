		...
		<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
		 ...
		 <td><?php echo ($v["ma_otherinfo"]); ?></td>
		  <td><?php echo ($v["ma_theme"]); ?></td>
           ...
           <!-- <td><a href="http://www.mmm-oa.com/<?php echo ($v["pic"]); ?>" target="_blank"><img src="http://www.mmm-oa.com/<?php echo ($v["pic"]); ?>" width="30" /></a></td> -->
          <td><a href="/admdgjmin.php/Home/Shop/ly_list_cl/id/<?php echo ($v["ma_id"]); ?>/" class="tablelink">回复处理</a>　<a href="/admdgjmin.php/Home/Shop/ly_list_del/id/<?php echo ($v["ma_id"]); ?>/" class="tablelink">删除</a></td>
