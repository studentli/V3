...
<label></label>
<div class="rightinfo">
  <form action="/admdgjmin.php/Home/Shop/jbzg_list_xgcl2"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
...
<table width="90%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" class="tablebg" id="table1">
  <tr>
    ...
    <td width="301" bgcolor="#FFFFFF" class="tbval" ><select name="IF_type" id="IF_type">
      ...
      <option value="dzp" <?php if($caution["if_type"] == 'dzp'): ?>selected="selected"<?php endif; ?>>大转盘公告</option>
            </select></td>
    </tr>
  ...
  <tr>
    <td bgcolor="#FFFFFF" class="tbkey" >简介：</td>
    <td bgcolor="#FFFFFF" class="tbval"><!-- 插入编辑器 -->
<textarea name="content" style="width:700px;height:200px;"><?php echo ($caution["if_content"]); ?></textarea></td>
    </tr>
  <!--微信填寫-->
</table>
<!--基本信息結束-->
