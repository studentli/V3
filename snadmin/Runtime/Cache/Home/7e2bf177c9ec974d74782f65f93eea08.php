...
<label></label>
<div class="rightinfo">
  <form action="/admdgjmin.php/Home/Shop/jbzg_list_xgcl"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
...
<textarea name="content" style="width:700px;height:200px;"></textarea></td>
    </tr>
  <!--微信填寫-->
</table>
<!--基本信息結束-->
