...
<body>
    ...
    <div class="rightinfo">
      <form action="/admdgjmin.php/Home/Index/tgbz_list_sd_cl"  name="xgmm" id="xgmm" method="post" autocomplete="off">

   
    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo ($aab[c]=0); ?> 提供用户:<?php echo ($aab[a]=$tgbzuser["user"]); ?>  提供金额:<?php echo ($tgbzuser["jb"]); ?> </td>
    <td align="right"><span id="yxje" style="color:#FF0000;">已选金额和=<?php echo ($check_money); ?></span>
      <input name="arrid" id="arrid" type="hidden" value="<?php echo ($check_id); ?>" />
	  <input name="arrzs" id="arrzs" type="hidden" value="<?php echo ($check_money); ?>" />
...
<br />
    ...
    <table class="tablelist">
        ...
        <td><label><input name="id" type="checkbox" data-value="<?php echo ($v["jb"]); ?>" class="dfdfe" value="<?php echo ($v["id"]); ?>" <?php if(in_array($v['id'],$check_array)) echo "checked"; ?> /></label></td>
...
.pages span.current{
   ...
   <div class="pages"><br />
	...
	$(".dfdfe").change(function(){
				var total = "<?php echo ($tgbzuser["jb"]); ?>";
				...
				$.get("<?php echo U('tgbz_list_sd_cookie');?>?id="+$("#arrid").val()+"&money="+$("#arrzs").val(),function(){}); 
			});
	/*$(function(){ 
$(".dfdfe").change(function() {
	...
	$("input[type='checkbox']").attr('disabled',true);
	 $.get("<?php echo U('tgbz_list_sd_cookie');?>?id="+$("#arrid").val()+"&money="+$("#arrzs").val(), function(result){
