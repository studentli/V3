...
<label></label>
<div class="rightinfo">
  <form action="/admdgjmin.php/Shop/Project/updateProject/id/<?php echo ($arr["id"]); ?>"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
...
<!--      <?php if(is_array($list)): foreach($list as $key=>$value): echo ($arr["pid"]); ?> eq <?php echo ($value['id']); endforeach; endif; ?> -->
...
<textarea name="content" style="width:700px;height:200px;visibility:show;"><?php echo ($arr["content"]); ?></textarea></td>
    </tr>
  <!--微信填寫-->
</table>
<!--基本信息結束-->
